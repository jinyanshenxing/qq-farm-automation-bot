...
<template>
  <div class="p-4">
    ...
    <div v-else-if="filteredList.length === 0 && searchKeyword" class="rounded-lg bg-white p-8 text-center text-gray-500 shadow dark:bg-gray-800">
      未找到匹配 "{{ searchKeyword }}" 的农作物
    </div>
